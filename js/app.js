$(document).ready(function() {
	...
	$(".optionsButton").on("click",function(){
		...
		// $(".introStartGameContainer").css("display","none");
	...
	// while var i is 0, and while i < array length -1, i++; I want to display
	// question. On submit button click the next object will be called on and will display question.
